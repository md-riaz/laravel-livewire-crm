        ...
        <div class="flex items-center gap-3">
            ...
            <div class="inline-flex rounded-md shadow-sm" role="group">
                <button wire:click="setViewMode('kanban')" 
                        ...
                        {{ $viewMode === 'kanban' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50' }}
                        focus:z-10 focus:ring-2 focus:ring-blue-500">
                    <svg class="w-5 h-5 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />
                    </svg>
                    <span class="ml-1 hidden sm:inline">Kanban</span>
                </button>
                <button wire:click="setViewMode('table')" 
                        class="px-4 py-2 text-sm font-medium rounded-r-lg border 
                        {{ $viewMode === 'table' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50' }}
                        focus:z-10 focus:ring-2 focus:ring-blue-500">
                    <svg class="w-5 h-5 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                    </svg>
                    <span class="ml-1 hidden sm:inline">Table</span>
                </button>
            </div>
